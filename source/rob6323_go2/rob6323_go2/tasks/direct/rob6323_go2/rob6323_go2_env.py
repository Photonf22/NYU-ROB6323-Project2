...
class Rob6323Go2Env(DirectRLEnv):
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        # 5.2 Implement Reward Terms line 176 to line 192
        ...
        self.rew_orient = self.robot.data.projected_gravity_b[:,0]**2 + self.robot.data.projected_gravity_b[:,1]**2
    ...
    # We implement a function that advances the gait clock and calculates where 
    # the feet should be based on the command velocity. 
    # We also need to reset the gait index on episode reset.
